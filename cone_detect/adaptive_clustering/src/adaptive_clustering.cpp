...
int main(int argc, char **argv) {
  ...
  /*** Subscribers ***/
  ros::NodeHandle nh;
  ros::Subscriber point_cloud_sub = nh.subscribe<sensor_msgs::PointCloud2>("velodyne_points_new", 1, pointCloudCallback);
  ...
  private_nh.param<float>("z_axis_min", z_axis_min_, -1.0);
