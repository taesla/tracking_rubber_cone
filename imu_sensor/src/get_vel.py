...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if (len(IMU_message)>55):
            ...
            vel[0]=round(float(data[7]),3)
            vel[1]=round(float(data[8]),3)
            vel[2]=round(float(data[9]),3)

            imu.linear_acceleration.x = vel[0]   #gravity eliminate velocity!!!!
            imu.linear_acceleration.y = vel[1]   #gravity eliminate velocity!!!!
            imu.linear_acceleration.z = vel[2]   #gravity eliminate velocity!!!!
